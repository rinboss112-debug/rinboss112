...
- Chỉ nhận Prime member có `FREE delivery/free shipping` và
  `Today/Tomorrow/Overnight`; Amazon Fresh, grocery và giao 2 giờ bị loại.
- Cột `delivery_detail` chỉ ghi thông tin Prime theo định dạng
