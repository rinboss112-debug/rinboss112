# RinBoss Product Image Collector 1.1.1
...
Với Amazon, extension chỉ đọc ảnh trong khối thư viện sản phẩm (`/images/I/`). Logo Prime, banner, video và ảnh sản phẩm gợi ý ở phần khác của trang sẽ bị loại.
