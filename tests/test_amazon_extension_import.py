...
class AmazonExtensionImportTests(unittest.TestCase):
    ...
    def test_real_extension_has_batch_worker_and_is_packaged(self) -> None:
        ...
        self.assertIn("compliance.js", names)
        ...
        self.assertIn('id="filter-temu-risk"', popup_html)
        self.assertIn('id="filter-temu-risk-terms"', popup_html)
        ...
        self.assertIn("matchedRiskTerms", popup_js)
